...
package PS.Data.Functor.Coproduct.Nested
import Foreign.PsRuntime.app
import Foreign.PsRuntime.appRun
object Module  {
  @JvmField
  val in9 = { v : Any ->
     PS.Data.Functor.Coproduct.Module.right
       .app(PS.Data.Functor.Coproduct.Module.right
              .app(PS.Data.Functor.Coproduct.Module.right
                     .app(PS.Data.Functor.Coproduct.Module.right
                            .app(PS.Data.Functor.Coproduct.Module.right
                                   .app(PS.Data.Functor.Coproduct.Module.right
                ...
                PS.Data.Functor.Coproduct.Module.right
                  .app(PS.Data.Functor.Coproduct.Module.right
                         .app(PS.Data.Functor.Coproduct.Module.left.app(v)))))))
      ))
  };
  @JvmField
  val in8 = { v : Any ->
              ...
              .app(PS.Data.Functor.Coproduct.Module.right
                     .app(PS.Data.Functor.Coproduct.Module.right
                            .app(PS.Data.Functor.Coproduct.Module.right
                                   .app(PS.Data.Functor.Coproduct.Module.right
                                          .app(
                PS.Data.Functor.Coproduct.Module.left.app(v)))))))
  };
  @JvmField
  val in6 = { v : Any ->
     PS.Data.Functor.Coproduct.Module.right
       .app(PS.Data.Functor.Coproduct.Module.right
              .app(PS.Data.Functor.Coproduct.Module.right
                     .app(PS.Data.Functor.Coproduct.Module.right
                            .app(PS.Data.Functor.Coproduct.Module.right
                                   .app(PS.Data.Functor.Coproduct.Module.left
                                          .app(v))))))
  };
  @JvmField
  val in5 = { v : Any ->
  ...
  @JvmField val in1 = PS.Data.Functor.Coproduct.Module.left;
  @JvmField
  val coproduct9 = { a : Any ->
     { b : Any ->
       { c : Any ->
         { d : Any ->
           { e : Any ->
                                                        ...
                                                        (__8 is PS.Data.Either.Module._Type_Either
                                                          ...
                                                          PS.Data.Void.Module.absurd
                                                            ...
                                                            PS.Data.Newtype.Module.unwrap
                                                              .app(
                                                                PS.Data.Const.Module.newtypeConst
                                                              )
                                                              .app(__9));
                                                        }
                                                        else -> (error(
                      ...
                      (__2 is PS.Data.Either.Module._Type_Either.Right) -> {
                        ...
                        when {
                          ...
                          (__3 is PS.Data.Either.Module._Type_Either.Right) -> {
                            ...
                            PS.Data.Void.Module.absurd
                              .app(PS.Data.Newtype.Module.unwrap
                                     .app(PS.Data.Const.Module.newtypeConst)
                                     .app(__4));
                          }
                          else -> (error("Error in Pattern Match") as Any)
                        };
